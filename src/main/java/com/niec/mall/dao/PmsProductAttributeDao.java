...
public interface PmsProductAttributeDao {
     ...
     * @return 对象列表
     */
    List<PmsProductAttribute> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<PmsProductAttribute> queryAll(PmsProductAttribute pmsProductAttribute);
